<template>
    <div class="newTD_page">
        ...
        >
            ...
            >
                ...
                <div class="bottom">
                    ...
                    <div class="lastShowTime"  v-if="reportData.end_time">{{reportData.end_time}}</div>
                </div>
            </div>
            <div
                class="score"
        ...
        <!--<div class="big_title" style="margin-top: 0.66rem">风险信息检测</div>
        <div class="content" v-if="reportData.risk_items">
            <div class="grxx_con" >
                &lt;!&ndash; '5230679' => '7天内申请人在多个平台申请借款',
...
28  敏感时间段申请1点至5点
      &ndash;&gt;
                ...
                <div class="fx_li">
                    &lt;!&ndash;手机号是否命中虚假号码库&ndash;&gt;
                    <div class="fx_msg" ><span>{{reportData.risk_items['5215371'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215371'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215371'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    &lt;!&ndash;身份证归属地是否有高风险&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215401'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215401'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215401'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    <div class="fx_msg">
                        &lt;!&ndash;身份证是否命中犯罪通缉名单&ndash;&gt;
                        <span>{{reportData.risk_items['5215453'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215453'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215453'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    <div class="fx_msg" >
                        &lt;!&ndash;身份证是否命中法院执行名单&ndash;&gt;
                        <span>{{reportData.risk_items['5215459'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215459'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>

                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215459'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    &lt;!&ndash; 身份证对应人是否存在助学贷款欠费历史&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215463'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215463'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215463'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    &lt;!&ndash;身份证是否命中信贷逾期名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215465'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215465'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_xd">
                        <div class="fx_xdli" v-for="(item,index) in reportData.risk_items['5215465'].court_details" :key="index">
                ...
                <div class="fx_li">
                    &lt;!&ndash;手机号是否命中信贷逾期名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215469'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215469'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215469'].fraud_type_display_name!=''">
                ...
                <div class="fx_li">
                    &lt;!&ndash;身份证是否命中高风险关注名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215471'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215471'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215471'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['5215471'].description}}</span>
                        <span>
                                 {{reportData.risk_items['5215471'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    <div class="fx_msg" >
                        &lt;!&ndash; 申请人信息是否命中中风险关注名单&ndash;&gt;
                        <span>{{reportData.risk_items['18'].risk_name}}</span>
                        <span v-if="reportData.risk_items['18'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['18'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['18'].description}}</span>
                        <span>
                                 {{reportData.risk_items['18'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    &lt;!&ndash; 手机号是否命中车辆租赁违约名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215495'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215495'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215495'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['5215495'].description}}</span>
                        <span>
                                 {{reportData.risk_items['5215495'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    &lt;!&ndash; 手机号是否命中车辆租赁违约名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['29'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215495'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['29'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['29'].description}}</span>
                        <span>
                                 {{reportData.risk_items['29'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">

                    &lt;!&ndash; 身份证是否命中车辆租赁违约名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215499'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215499'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215499'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['5215499'].description}}</span>
                        <span>
                                 {{reportData.risk_items['5215499'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">

                    &lt;!&ndash; 身份证是否命中故意违章乘车名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215527'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215527'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215527'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['5215527'].description}}</span>
                        <span>
                                 {{reportData.risk_items['5215527'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                ...
                <div class="fx_li">
                    ...
                    &lt;!&ndash; 身份证是否命中法院失信名单&ndash;&gt;
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['5215429'].risk_name}}</span>
                        <span v-if="reportData.risk_items['5215429'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['5215429'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['5215429'].description}}</span>
                        <span>
                                 {{reportData.risk_items['5215429'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>

            </div>
            <div class="analysisWrods" v-if="reportData.risk_info_explain">
                {{reportData.risk_info_explain}}
            </div>
        </div>-->
        <div class="big_title" style="margin-top: 0.66rem" v-if="reportData.risk_items" >风险信息检测</div>
        <div class="content" v-if="reportData.risk_items" style="padding-bottom:0.3rem">
            <div class="grxx_con" >
       ...
       -->
                ...
                <div class="fx_li">
                    ...
                    <div class="fx_xd">
                        <div class="fx_xdli" v-for="(item,index) in reportData.risk_items['5215469'].court_details" :key="index">
                            <div class="fx-li-item"><span>逾期金额：</span><span>{{item.overdue_amount_range}}</span></div>
                            <div class="fx-li-item"><span>逾期笔数：</span><span>{{item.overdue_count}}</span></div>
                            <div class="fx-li-item hastop"><span>逾期天数：</span><span>{{item.overdue_day_range}}</span></div>
                            <div class="fx-li-item hastop"><span>逾期入库时间：</span><span>{{item.overdue_time}}</span></div>
                ...
                <div class="fx_li">
                    ...
                    <!-- 手机号命中高风险关注名单-->
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['26'].risk_name}}</span>
                        <span v-if="reportData.risk_items['26'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['26'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['26'].description}}</span>
                        <span>
                                 {{reportData.risk_items['26'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    ...
                    <!-- 申请人信息命中低风险关注名单-->
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['27'].risk_name}}</span>
                        <span v-if="reportData.risk_items['27'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['27'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['27'].description}}</span>
                        <span>
                                 {{reportData.risk_items['27'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    ...
                    <!-- 敏感时间段申请1点至5点-->
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['28'].risk_name}}</span>
                        <span v-if="reportData.risk_items['28'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['28'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['28'].description}}</span>
                        <span>
                                 {{reportData.risk_items['28'].fraud_type_display_name}}
                           </span>
                    </div>
                </div>
                <div class="fx_li">
                    ...
                    <div class="fx_msg" >
                        <span>{{reportData.risk_items['29'].risk_name}}</span>
                        <span v-if="reportData.risk_items['29'].fraud_type_display_name!=''" class="yes">是</span>
                        <span v-else class="no">否</span>
                    </div>
                    <div class="fx_msg-type" v-if="reportData.risk_items['29'].fraud_type_display_name!=''">
                        <span class="name">{{reportData.risk_items['29'].description}}</span>
        ...
        <div class="content">
            <div class="duoPT_btn">
                <span :class="TD_duotou_cur=='5230679'?'select':''" @click="TD_duotou_select('5230679')">七天内</span>
                <span :class="TD_duotou_cur=='20'?'select':''" @click="TD_duotou_select('20')">一个月内</span>
                <span :class="TD_duotou_cur=='5230683'?'select':''" @click="TD_duotou_select('5230683')"> 三个月内</span>
            </div>
            ...
            <div class="analysisWrods" v-if="reportData.multi_platform_explain">
                {{reportData.multi_platform_explain}}
            </div>
            ...
            <div class="sqxw_jc">
                <div class="sqxw_jc_li">
                    <div class="sqxw_jc_li_t">
                        ...
                        <span class="t_num">{{reportData.risk_items['5215541'].frequency_detail_list.length}}</span>
                    </div>
                    <div class="sqxw_jc_li_item" v-if="reportData.risk_items['5215541'].frequency_detail_list.length>0">
                        <div class="sqxw_jc_li_item_label">关联借款人手机号列表</div>
                        <div class="sqxw_jc_li_item_con">
                            <span v-for="(item,index) in reportData.risk_items['5215541'].frequency_detail_list">{{item}}</span>
                        </div>
                    </div>
                ...
                <div class="sqxw_jc_li">
                    <div class="sqxw_jc_li_t">
                        ...
                        <span class="t_num">{{reportData.risk_items['5215543'].frequency_detail_list.length}}</span>
                    </div>
                    <div class="sqxw_jc_li_item" v-if="reportData.risk_items['5215543'].frequency_detail_list.length>0">
                        <div class="sqxw_jc_li_item_label">关联借款人身份证列表</div>
                        <div class="sqxw_jc_li_item_con">
                            <span style="width: 100%" v-for="(item,index) in reportData.risk_items['5215543'].frequency_detail_list">{{item}}</span>
                        </div>
                    </div>
                    <div v-else class="reportItem-nodata">无记录</div>
                </div>
                <!--<div class="sqxw_jc_li">
                     <div class="sqxw_jc_li_t">
                         <span class="t_circle"></span>
                         <span class="t_label">{{reportData.risk_items['24'].risk_name}}</span>

                         <span  v-if="reportData.risk_items['24'].fraud_type_display_name!=''" class="t_num yes">是</span>
                         <span  v-else class="t_num no">否</span>
                     </div>
                 </div>
                <div class="sqxw_jc_li">
                     <div class="sqxw_jc_li_t">
                         <span class="t_circle"></span>
                         <span class="t_label">{{reportData.risk_items['25'].risk_name}}</span>
                         <span  v-if="reportData.risk_items['25'].fraud_type_display_name!=''" class="t_num yes">{{reportData.risk_items['25'].count}}</span>
                         <span  v-else class="t_num no">{{reportData.risk_items['25'].count}}</span>
                     </div>
                 </div>-->
            </div>
            <div class="analysisWrods" v-if="reportData.apply_behavior_explain">
                {{reportData.apply_behavior_explain}}
            </div>
        </div>
        <!--失信情况-->

        <div class="muchHead" style="overflow: hidden" v-if="reportData.risk_items['5215429'].fraud_type_display_name!=''">
            <div class="headline">失信情况</div>
            <div class="lostletter_subtitle" >失信明细</div>
            <div class="lostLetter" v-for="(item,index) in reportData.risk_items['5215429'].court_details">
...
<style scoped lang="less">
    .newTD_page{
        ...
        .reportTips{
            font-size: 0.26rem;padding: 0 0.3rem;color:red;margin-bottom: 0.1rem;
        }
        .big_title{
