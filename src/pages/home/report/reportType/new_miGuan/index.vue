<template>
    <div class="newMiGuan" v-if="reportData">
        <!-- 个人信息 -->
        <div
            class="banner"
        ...
        <div class="blacklist">
            <div class="title">
                ...
                <div
                    ...
                    :style="{backgroundImage:`url(${require('@/assets/miGuan/newMiGuan-question.png')})`}"
                ></div>
            </div>
            <div class="content">
                <div class="wrap">
                    <div class="top">
                        <div class="item">
                            ...
                            <div class="right" :class="{green:!reportData.user_gray.blacklist_category}">{{reportData.user_gray.blacklist_category}}</div>
                        </div>
                        <div class="item">
        ...
        <div class="linker">
            ...
            <div class="content">
                ...
                <div class="analysisWrods" v-if="reportData.contact_suspicion_explain">
                    {{reportData.contact_suspicion_explain}}
                </div>
        ...
        <div class="search_hostory">
            ...
            <div class="content">
                <div class="wrap" style="padding-left: 0;padding-right: 0" v-if="reportData.user_searched_history_by_day">
                    ...
                    <div id="cor_box" style="overflow:hidden;position:relative;height: 4.66rem;">
                        <div
                            ...
                            class="clearfix"
                        >
                            <div style="width: 100%;padding: 0 0.3rem;box-sizing: border-box" class="item_list" v-for="(item,index) in historyDate" :key="index" >
                                <div class="item">
                                    <div class="left">查询次数</div>
                                    <div class="right">{{reportData.user_searched_history_by_day[historyDate[index]].cnt}}</div>
                                </div>
                                <div class="item">
        ...
        <div class="org_search_hostory">
            <div class="title">
                ...
                <div
                    class="right"
                    @click.stop="showTips(reportData.tips.user_searched_history_by_orgs)"
                    :style="{backgroundImage:`url(${require('@/assets/miGuan/newMiGuan-question.png')})`}"
                ></div>
            </div>
        ...
        <div class="id_doubt">
            <div class="title">
                ...
                <div
                    class="right"
                    @click.stop="showTips(reportData.tips.user_idcard_suspicion)"
                    :style="{backgroundImage:`url(${require('@/assets/miGuan/newMiGuan-question.png')})`}"
                ></div>
            </div>
            <div class="content">
                <div class="wrap">
                    <div class="top">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_idcard_suspicion.idcard_with_other_names.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                    <div class="center">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_idcard_suspicion.idcard_with_other_phones.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                    <div class="bottom">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_idcard_suspicion.idcard_applied_in_orgs.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="wrap">
                    <div class="top">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_phone_suspicion.phone_with_other_names.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                    <div class="center">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_phone_suspicion.phone_with_other_idcards.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                    <div class="bottom">
                        <div class="item_list">
                            ...
                            <div v-if="reportData.user_phone_suspicion.phone_applied_in_orgs.length==0" class="reportItem-nodata">无记录</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- 弹窗组件 -->
        <flypopup v-model="taskTipsShow" :popupStyle="{background: 'transparent',}">
            <div class="pop_up" :style="{backgroundImage:`url(${tipsPic})`}">
                <div
                    @click.stop="taskTipsShow=false"
                    class="close"
                    :style="{backgroundImage:`url(${require('@/assets/miGuan/newMiGuan-close.png')})`}"
                ></div>
            </div>
        </flypopup>
    </div>
