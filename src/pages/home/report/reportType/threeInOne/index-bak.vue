    ...
    <div class="threeInOne" >
        ...
        >
            <div class="title">
                ...
                <div class="title-2">{{threeInOneData.tongDun.note}}</div>
            </div>
            <div
                class="personInfo"
            ...
            >
                <div class="top">
                    ...
                    <div class="base">
                        <div class="base_top">
                            <div class="name">{{threeInOneData.miGuanV3.user_basic.user_name}}</div>
                            <div class="age">{{threeInOneData.miGuanV3.user_basic.user_age}}岁</div>
                            <div class="gender">{{threeInOneData.miGuanV3.user_basic.user_gender}}</div>
                        </div>
        ...
        <div v-if="false" class="big_title" style="margin-top: 0.66rem" >逾期行为详情</div>
        <div v-if="false" class="content" style="margin-top: 0.3rem" >
        ...
        <div v-if="false" class="big_title" style="margin-top: 0.66rem" >负债情况详情</div>
        <div v-if="false" class="content" style="margin-top: 0.3rem" >
            <div  class="yqxw_content"  >
                <div class="t-c">
                    <div class="t-c_li_t" >
        ...
        <!--<div class="big_title" v-if="threeInOneData.miGuanV3">身份证存疑</div>
        <div class="content" v-if="threeInOneData.miGuanV3">
            <div class="title">
                <span>使用过此身份证的其它姓名</span><span>最后使用时间</span>
            </div>
            <div class="sfz_cy_detial" >
                <div class="item_li"
                     v-for="(item,index) in threeInOneData.miGuanV3.user_idcard_suspicion.idcard_with_other_names"
                     :key="index"
                >
                    <span class="label">{{item.susp_name}}</span><span class="num">{{item.susp_updt}}</span>
                </div>
                <div v-if="threeInOneData.miGuanV3.user_idcard_suspicion.idcard_with_other_names.length==0" class="reportItem-nodata">无记录</div>
            </div>
            <div class="title" style="margin-top: 0.29rem">
                <span>使用过此身份证的其它手机</span><span>最后使用时间</span><span>出现次数</span>
            </div>
            <div class="sfz_cy_detial" >
                <div class="item_li"
                     v-for="(item,index) in threeInOneData.miGuanV3.user_idcard_suspicion.idcard_with_other_phones"
                     :key="index"
                >
                    <span class="label">{{item.susp_phone}}</span>
                    <span class="num">{{item.susp_updt}}</span>
                    <span class="num">{{item.times}}</span>
                </div>
                <div v-if="threeInOneData.miGuanV3.user_idcard_suspicion.idcard_with_other_phones.length==0" class="reportItem-nodata">无记录</div>
            </div>

            <div class="sfz_data_type" >
                <div class="title" style="margin-top: 0.32rem;padding-top: 0.5rem">
                    <span>提供数据的机构类型</span><span>最后使用时间</span>
                </div>
                <div style="background: #fff">
                    <div class="item_li"
                         v-for="(item,index) in threeInOneData.miGuanV3.user_idcard_suspicion.idcard_applied_in_orgs"
                         :key="index"
                    >
                        <span class="label">{{item.susp_org_type}}</span>
                        <span class="num">{{item.susp_updt}}</span>
                    </div>
                   <div v-if="threeInOneData.miGuanV3.user_idcard_suspicion.idcard_applied_in_orgs.length==0" class="reportItem-nodata">无记录</div>
                </div>
            </div>
        </div>-->
        <!--<div class="big_title" style="margin-top: 0.66rem" v-if="threeInOneData.miGuanV3">手机存疑</div>
        <div class="content" style="margin-top: 0.3rem"  v-if="threeInOneData.miGuanV3">
            <div class="sfz_data_type" style="padding-bottom: 0">
                <div class="title" style="margin-top: 0;padding-top: 0.42rem">
                    <span>使用过此手机的其它姓名</span><span>最后使用时间</span>
                </div>
                <div style="background: #fff">
                    <div class="item_li"
                         v-for="(item,index) in threeInOneData.miGuanV3.user_phone_suspicion.phone_with_other_names"
                         :key="index"
                    >
                        <span class="label">{{item.susp_name}}</span>
                        <span class="num">{{item.susp_updt}}</span>
                    </div>
                   <div v-if="threeInOneData.miGuanV3.user_phone_suspicion.phone_with_other_names.length==0" class="reportItem-nodata">无记录</div>
                </div>
            </div>
            <div class="sfz_data_type" style="padding-bottom: 0">
                <div class="title" style="margin-top: 0;padding-top: 0.42rem">
                    <span>使用过此手机的其它身份证</span><span>最后使用时间</span>
                </div>
                <div style="background: #fff">
                    <div class="item_li"
                         v-for="(item,index) in threeInOneData.miGuanV3.user_phone_suspicion.phone_with_other_idcards"
                         :key="index"
                    >
                        <span class="label">{{item.susp_idcard}}</span>
                        <span class="num">{{item.susp_updt}}</span>
                    </div>
                    <div v-if="threeInOneData.miGuanV3.user_phone_suspicion.phone_with_other_idcards.length==0" class="reportItem-nodata">无记录</div>
                </div>
            </div>
            <div class="sfz_data_type" style="padding-bottom: 0">
                <div class="title" style="margin-top: 0;padding-top: 0.42rem">
                ...
                <div style="background: #fff">
                    <div class="item_li"
                         v-for="(item,index) in threeInOneData.miGuanV3.user_phone_suspicion.phone_applied_in_orgs"
                         :key="index"
                    >
                        <span class="label">{{item.susp_org_type}}</span>
                        <span class="num">{{item.susp_updt}}</span>
                    </div>
                    <div v-if="threeInOneData.miGuanV3.user_phone_suspicion.phone_applied_in_orgs.length==0" class="reportItem-nodata">无记录</div>
                </div>
            </div>
        </div>-->
        <div class="big_title" v-if="threeInOneData.miGuanV3&&threeInOneData.miGuanV3.user_gray" style="margin-top: 0.66rem">联系人存疑信息</div>
        <div class="content" v-if="threeInOneData.miGuanV3&&threeInOneData.miGuanV3.user_gray">
            <div class="lxr_cy_detial" >
...
'3个月内申请人手机号作为联系人手机号出现的次数过多'], '25'-->
            ...
            <div class="sqxw_jc">
                ...
                <!-- <div class="sqxw_jc_li">
                      <div class="sqxw_jc_li_t">
                          <span class="t_circle"></span>
                          <span class="t_label">{{threeInOneData.tongDun.risk_items['24'].risk_name}}</span>

                          <span  v-if="threeInOneData.tongDun.risk_items['24'].fraud_type_display_name!=''" class="t_num yes">是</span>
                 ...
                 <div class="sqxw_jc_li">
                      <div class="sqxw_jc_li_t">
                          <span class="t_circle"></span>
                          <span class="t_label">{{threeInOneData.tongDun.risk_items['25'].risk_name}}</span>
                          <span  v-if="threeInOneData.tongDun.risk_items['25'].fraud_type_display_name!=''" class="t_num yes">{{threeInOneData.tongDun.risk_items['25'].count}}</span>
                          <span  v-else class="t_num no">{{threeInOneData.tongDun.risk_items['25'].count}}</span>
                      </div>
                  </div>-->
            </div>
       ...
       &ndash;&gt;
                ...
                <div class="fx_li">
                    ...
                    <div class="fx_msg-type" v-if="threeInOneData.tongDun.risk_items['5215469'].fraud_type_display_name!=''">
                        <span class="name">{{threeInOneData.tongDun.risk_items['5215469'].description}}</span>
                        <span>{{threeInOneData.tongDun.risk_items['5215469'].fraud_type_display_name}}</span>
                    </div>
                </div>
                <div class="fx_li">
                ...
                <div class="fx_li">&lt;!&ndash;手机号是否命中车辆租赁违约名单&ndash;&gt;
       ...
       -->
        ...
        <!--失信情况-->
       <!-- <div class="muchHead" style="overflow: hidden" v-if="threeInOneData.tongDun.risk_items['5215503'].fraud_type_display_name!=''">
            <div class="headline">失信情况</div>
            <div class="lostletter_subtitle" >失信明细</div>
            <div class="lostLetter" v-for="(item,index) in threeInOneData.tongDun.risk_items['5215503'].court_details">
        ...
        <div class="muchHead" style="overflow: hidden" v-if="threeInOneData.tongDun.risk_items['5215429'].fraud_type_display_name!=''">
            <div class="headline">失信情况</div>
            <div class="lostletter_subtitle" >失信明细</div>
