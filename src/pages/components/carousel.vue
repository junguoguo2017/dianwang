<template>
    <div :style="{overflow:'hidden',position:'relative'}" id="cor_box">
        <div
            id="lunbo"
    ...
    export default {
        ...
        mounted(){
            ...
            this.$nextTick(()=>{
                ...
                document.getElementById('lunbo').ontouchcancel = function () {
        ...
        methods:{
            ...
            touchmove(e){
                ...
                document.getElementById('lunbo').style.transition = "none";
                document.getElementById('lunbo').webkitTransform = "none";
            ...
            touchend(e){
                ...
                if(Math.abs(this.disX) >this.childrens[0].offsetWidth/3){
                    ...
                    this.moveX = this.touchendX
                    document.getElementById('lunbo').style.transition = 'left .3s ease-in';
                };
                this.disX = 0
                if(this.autoplay){
                    this.lunboInit()
            ...
            touchAction(go,cb){
                ...
                if(this.currentIndex==0){
                    ...
                    function startInit(){
                        ...
                        document.getElementById('lunbo').webkitTransform = "none";
                        self.lunboq = true;
                        document.getElementById('lunbo').removeEventListener('transitionend',startInit)
                    }
                    document.getElementById('lunbo').addEventListener('transitionend',startInit, false)
                    ...
                    function endInit(){
                        ...
                        document.getElementById('lunbo').webkitTransform = "none";
                        self.lunboq = true;
                        document.getElementById('lunbo').removeEventListener('transitionend',endInit)
                    }
                    document.getElementById('lunbo').addEventListener('transitionend',endInit, false)
                };
